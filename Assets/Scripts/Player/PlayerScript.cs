...
public class PlayerScript : MonoBehaviour
{
    ...
    private void ActivateBoostParticles(bool turbo)
    {
        foreach (GameObject boostParticle in _boostParticles)
        {
            ...
            if (turbo)
            {
                ...
                vfx.SetInt("GradientColor", 1);
            }
            else
            {
                vfx.SetVector3("Velocity", new Vector3(0, 0.03f, 0));
                vfx.SetInt("SpawnRate", 32);
                vfx.SetInt("GradientColor", 0);
            }
    ...
    private void ShowHealthDecreaseAura()
    {
        ...
        Destroy(healthDecreaseAura, 1f);
    }

    private void ShowRingAura()
    {
